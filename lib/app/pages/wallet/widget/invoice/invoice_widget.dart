                  ...
                  child: Column(
                    children: [
                      ...
                      Expanded(
                        child: Visibility(child: Column(children: [
                          ...
                          Expanded(
                            child: SingleChildScrollView(
                              child: Column(
                                children: logic.invoiceModel.asMap().entries.map((s){
                                  return  Container(
                                    width: 100.w,
                                    height: 10.h,
                        ...
                        logic.invoiceModel.isNotEmpty,),
                      ),
                      Visibility(child: Column(children: [

                        Text("This list is Empty",style: TextStyle(fontWeight: FontWeight.w400,fontSize: 14.sp),),
                        Container(
                            width: 60.w,
                            height: 25.h,
