  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Container(
        ...
        child: logic.livemodels.isEmpty
            ? LiveEmptyState()
            : Container(
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    ...
                    SizedBox(height: 3.h,),
                    Text("my_channel_6".tr,style: TextStyle(fontWeight: FontWeight.bold,fontSize: 13.sp),),
                    Text("my_channel_7".tr,style: TextStyle(fontWeight: FontWeight.w300,fontSize: 9.sp,color: "#9C9CB8".toColor()),),
                    SizedBox(height: 2.h,),
                          ...
                          children: [
                            Container(
                              ...
                              child: ClipRRect(
                                ...
                                child: Stack(
                                  children: [
                                    SizedBox.expand(child: Image.asset("assets/all/images/tumnial.png",fit: BoxFit.cover,)),
                                    Align(
                                      ...
                                      child: Container(
                                        ...
                                        child: MaterialButton(
                                          padding: EdgeInsets.zero,
                                            ...
                                            child:Container(
                                                width: 7.w,
                                                height: 7.w,child: SvgPicture.asset("assets/all/icons/switch_channels.svg",))),
                                      ),
                                    )
                                  ],
                                ),
                            ...
                            SizedBox(height: 1.h,),
                            Text("Test",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 10.sp),)
                    ...
                    Container(
                      ...
                      child: MaterialButton(
                        ...
                        child: Center(
                          child: Center(
                            child: Text("my_channel_8".tr,style: TextStyle(fontWeight: FontWeight.w500),),
                          ),
                        ),
                      ),
                    )
