              ...
              child: Stack(
                ...
                children: [
                  SizedBox.expand(
                    child: ClipRRect(
                      ...
                      child: (elementAt['thumbnails'].toString().length>3)?Image.network("${elementAt['thumbnails']['336x366']}", fit: BoxFit.cover)
                          :Image.asset("assets/${F.assetTitle}/images/tum_image.jpeg", fit: BoxFit.cover),
                    )
                    ,
                  ),
                  Container(
                  ...
                  Padding(
                    ...
                    child: SvgPicture.asset("assets/${F.assetTitle}/icons/picure_icon.svg" , color: AppColor.grayLightColor.withOpacity(0.5)  , height: 1.8.h),
                  )
                ],
              )
          ),
