              ...
              child: Stack(
                ...
                children: [
                  SizedBox.expand(
                    child: ClipRRect(
                      ...
                      child: (elementAt['asset']['thumbnails'].toString().length>3)?Image.network("${elementAt['asset']['thumbnails']['226x226']}", fit: BoxFit.cover)
                          :Image.asset("assets/${F.assetTitle}/images/tum_sound.jpeg", fit: BoxFit.cover),
                    )
                    ,
                  ),
                  Container(
                  ...
                  Padding(
                    ...
                    child: SvgPicture.asset("assets/${F.assetTitle}/icons/sound_icon.svg" , color: AppColor.grayLightColor.withOpacity(0.5)  , height: 1.8.h),
                  )
                ],
              )
          ),
