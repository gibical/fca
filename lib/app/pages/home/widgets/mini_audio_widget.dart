...
class MiniAudioWidget extends StatelessWidget {
  ...
  ContentModel model;
  MiniAudioWidget({this.height,required this.model});
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: MaterialButton(
        onPressed: (){
          Get.toNamed(PageRoutes.DETAILMUSIC, arguments: {'id': model.id});
                  ...
                  child: Stack(
                    children: [
                      ...
                      Align(
                        ...
                        child: Container(
                          margin: EdgeInsets.all(2.w),
                          child: SvgPicture.asset("assets/all/icons/mini_icon_audio.svg"),
                        ),
                      ),
                      Align(
...
class ShimmerMiniAudioWidget extends StatelessWidget {
  ...
  ShimmerMiniAudioWidget({this.height});
