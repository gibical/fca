...
class HomeScreen extends GetView<WrapperController> {
  HomeLogic homeLogic = Get.find<WrapperController>().homeLogic;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: FocusDetector(
        onFocusGained: () {
          homeLogic.pageController.animateToPage(homeLogic.selectedTab.value,
              ...
              children: [
                ...
                Expanded(
                  child: PageView.builder(
                    ...
                    itemBuilder: (w, i) {
                      return homeLogic.homeTabsModel.elementAt(i).widget;
                    },
