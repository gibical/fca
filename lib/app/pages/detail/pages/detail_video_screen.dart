...
class DetailVideoScreen extends StatelessWidget {
  const DetailVideoScreen({super.key});
      ...
      body: GetBuilder<DetailController>(
        builder: (controller){
          ...
          return CustomScrollView(
            slivers: [
              CustomAppBarVideoAndImageDetailWidget(selectedItem: selectedItem, isVideo: true,),
              SliverToBoxAdapter(
                child: Padding(
                    ...
                    children: [
                      ...
                      Row(
                        children: [
                          ...
                          Text(selectedItem['asset']['user']['username'] , style: FontStyleApp.bodySmall.copyWith(
                              color: AppColor.grayLightColor.withOpacity(0.8),
                              fontSize: 13
                          ),),
                          Spacer(),
                      ...
                      Wrap(
                        children: [
                          CardMarkSinglePageWidget(label: 'Genre' , type: (selectedItem['genre'].length > 5) ? '${selectedItem['genre'].substring(0, 5)}...' : selectedItem['genre']),
