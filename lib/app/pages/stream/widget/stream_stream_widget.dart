        ...
        builder: (logic) {
         ...
         Privacy Awareness: Be cautious of any sensitive information visible on the screen.""",
                  ...
                  Obx(() {
                    return Visibility(
                      visible:
                      _streamController.isScreenRecordingTimeVisible.value,
                      child: Align(
                        ...
                        child: SafeArea(
                          child: Container(
                            ...
                            child: Row(
                              ...
                              children: [
                                SvgPicture.asset(
                                    "assets/${F.assetTitle}/images/record.svg"),
                                Text(
                      ...
                      child: Container(
                        child: Container(
                          ...
                          child: Row(
                            ...
                            children: [
                              SvgPicture.asset(
                                  "assets/${F.assetTitle}/icons/iphone.svg",
                                  height: 16,
                                  color: Colors.grey),
                              SizedBox(
                                width: 2.w,
                              ...
                              Obx(() {
                                return Text(
                                  '${_streamController
                                      .isScreenRecordingTimeVisible.value
                                      ? "Stop"
                                      : "Start"} Stream'
                                      .tr,
